		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapprakhartestui5test-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapprakhartestui5test-display": {
								"semanticObject": "sapprakhartestui5test",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.prakhar.test.ui5test",
									"url": sap.ui.require.toUrl("sap/prakhar/test/ui5test")
								}
							}
						}
					}
